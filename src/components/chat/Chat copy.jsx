...
const Chat = () => {
    ...
    useEffect(() => {
      ...
      const handleSendButton = () => {
        ...
        // Example of sending data, adjust as per your application's sending mechanism
        const dataToSend = {
          emotion: mostPrevalentEmotion,
          confidence: confidence.toFixed(2) // Ensure confidence is formatted as needed
          // Add more data as necessary
        };
      setEmoData(dataToSend || "Not Detected");
        // Perform send operation with dataToSend, such as sending it via WebSocket, HTTP POST, etc.
      };
    ...
    const handleSend = async () => {
        ...
        handleSendButton(); // Call to calculate and set emoData
        ...
        try {
          ...
          await updateDoc(doc(db, "chats", chatId), {
            messages: arrayUnion({
              ...
              text,
              emoData: emoData, // Include emoData in the message object
              createdAt: new Date(),
              ...(imgUrl && { img: imgUrl }), // Conditionally add imgUrl if it exists
            }),
          });
            ...
            <div className="center">
                {chat?.messages?.map((message) => (
                    ...
                    <div className="texts">
                        ...
                        {message.emoData && ( 
                            <>
                                <p>Emotion: {message.emoData.emotion}</p>
                                <p>Confidence: {message.emoData.confidence}</p>
